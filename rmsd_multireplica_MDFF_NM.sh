...
# convert trr trajectories of c-alpha only to dcd
catdcd -o temp_ca.dcd -otype dcd -trr temp_ca.trr

# copy concatenated structure file to outdir
cp temp_ca.trr ../${outdir}/${i}_ca.trr
cp temp_ca.dcd ../${outdir}/${i}_ca.dcd
...
rm -f temp_fit.trr temp_ca.trr temp_ca.dcd
rm -f \#*
